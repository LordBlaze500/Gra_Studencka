...
function Recruiter($Troop, $Number)
{
   ...
   if ($Result == 1) header('Location: http://grastudencka.cba.pl/index.php?l=transit&info=recruited');
   if ($Result == 2) header('Location: http://grastudencka.cba.pl/index.php?l=transit&info=noresources');
   if ($Result == 3) header('Location: http://grastudencka.cba.pl/index.php?l=transit&info=nospace');
}

if ($_GET['inspector_number'] && $Transit->Status_Getter() > 0)
{
   $Number = $_GET['inspector_number'];
   Recruiter($Inspector, $Number);
}

if ($_GET['veteran_number'] && $Transit->Status_Getter() > 1)
{
   $Number = $_GET['veteran_number'];
...
<body>
   ...
   <table border=1 bgcolor=<?php Bg_Color_Three();?>>
      ...
      <tr>
         <td><b><a href="?l=inspector"><img src="img/kanar.png" width="30" height="30">Kanar</a></b></td>
      ...
      <tr>
         <td><b><a href="?l=veteran"><img src="img/weteran.png" width="30" height="30">Kanar weteran</a></b></td>
         <td><b><center>
